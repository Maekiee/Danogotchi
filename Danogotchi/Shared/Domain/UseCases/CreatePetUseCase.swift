...
protocol CreatePetUseCase {
    /// 온보딩에서 펫을 만든다. 이미 있으면 만들지 않고 기존 펫을 돌려준다.
...
final class DefaultCreatePetUseCase: CreatePetUseCase {
    ...
    func execute(type: PetType, name: String) -> Pet {
        ...
        let pet = Pet(
            ...
            level: 0,
            totalExperience: 0,
            satiety: PetStatePolicy.maxStat,
            hydration: PetStatePolicy.maxStat,
            fun: PetStatePolicy.maxStat,
            cleanliness: PetStatePolicy.maxStat,
