...
final class OldLibraryViewController: BaseViewController {
    ...
    private let viewModel: OldLibraryViewModel
    private var selectedBookId: UUID?
    weak var delegate: LibraryViewControllerDelegate?
    
    init(viewModel: OldLibraryViewModel) {
    ...
    private enum Item: Hashable {
        ...
        case recommend(OldLibraryViewModel.RecommendItem)
    }
    ...
    private var recommendCellRegistration: UICollectionView.CellRegistration<RecommendBookCollectionViewCell, OldLibraryViewModel.RecommendItem>!
    ...
    private func setupCellRegistrations() {
        ...
        recommendCellRegistration = UICollectionView.CellRegistration<RecommendBookCollectionViewCell, OldLibraryViewModel.RecommendItem> { [weak self] cell, indexPath, item in
            guard let self = self else { return }
    ...
    private func applySnapshot(myBook: VocabBook?, recommendItems: [OldLibraryViewModel.RecommendItem]) {
...
extension OldLibraryViewController {
    private func bind() {
        ...
        let input = OldLibraryViewModel.Input(
